    ...
    <div class="container">
        ...
        <main class="row">
            ...
            <p class="d-grid gap-2">
                <a class="btn btn btn-outline-info" data-bs-toggle="collapse" href="#HowBuy" role="button" aria-expanded="false" aria-controls="collapseExample">
                    Как купить?
                </a>
                <a class="btn btn btn-outline-info" data-bs-toggle="collapse" href="#HowDeliver" role="button" aria-expanded="false" aria-controls="collapseExample">
                    Как доставить?
                </a>
                <a class="btn btn btn-outline-info" data-bs-toggle="collapse" href="#guarantee" role="button" aria-expanded="false" aria-controls="collapseExample">
                    Какая гарантия?
                </a>
            </p>
